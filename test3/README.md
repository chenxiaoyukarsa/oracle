...
•第1步：以system登录到pdborcl，创建用户chenxiaoyu1，并授权和分配空间：

CREATE USER chenxiaoyu1 IDENTIFIED BY 123 DEFAULT TABLESPACE users TEMPORARY TABLESPACE temp;
ALTER USER chenxiaoyu1 QUOTA 50M ON users;

•第2步：使用system用户给自己的用户分配USERS,USERS02,USERS03三个分区的使用权限。

ALTER USER chenxiaoyu1 QUOTA UNLIMITED ON USERS;
ALTER USER chenxiaoyu1 QUOTA UNLIMITED ON USERS02;
ALTER USER chenxiaoyu1 QUOTA UNLIMITED ON USERS03;
exit
...
select * from chenxiaoyu1.orders where order_date
between to_date('2017-1-1','yyyy-mm-dd') and to_date('2018-6-1','yyyy-mm-dd');

select a.ORDER_ID,a.CUSTOMER_NAME,
b.product_name,b.product_num,b.product_price
from chenxiaoyu1.orders a,chenxiaoyu1.order_details b where
